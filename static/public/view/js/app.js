...
var App = function () {
    ...
    var handleSidebarMenu = function () {
        jQuery('.page-sidebar').on('click', 'li > a', function (e) {
                ...
                parent.children('li.open').children('a').children('.arrows').removeClass('open').removeClass("glyphicon-chevron-up").addClass("glyphicon-chevron-down");
                parent.children('li.open').children('.sub-menu').slideUp(200);
                parent.children('li.open').removeClass('open');

                var sub = jQuery(this).next();
                if (sub.is(":visible")) {
                    jQuery('.arrows', jQuery(this)).removeClass("open");
                    jQuery(this).parent().removeClass("open");
                    sub.slideUp(200, function () {
                            handleSidebarAndContentHeight();
                        });
                } else {
                    jQuery('.arrows', jQuery(this)).addClass("open").removeClass("glyphicon-chevron-down").addClass("glyphicon-chevron-up");
        ...
        jQuery('.page-sidebar').on('click', ' li > a.ajaxify', function (e) {
                ...
                menuContainer.children('arrows.open').removeClass('open');

                $(this).parents('li').each(function () {
                        $(this).addClass('active');
                        $(this).children('a > span.arrows').addClass('open');
                    });
